...
### Функции модели детекции:
1) Получение предсказания примитивных объектов изображения

### Функции модели классификации:
1) Получение предсказания класса изображения
